...
def main():
    ...
    for episode in range(30000):
        ...
        while True:
            ...
            next_state_idx, velocity_idx = idx_state(env, next_state)
            velo.append(velocity_idx)
        ...
        if episode % 1000 == 0:
            ...
            np.save("./results/maxent_q_table.npy", arr=q_table)
            pylab.plot(
